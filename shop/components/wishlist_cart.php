...
if(isset($_POST['add_to_wishlist'])){
   ...
   if($user_id == ''){
      ...
      // Check if the product is already in the wishlist using pid and user_id
      ...
      if($check_wishlist_numbers->rowCount() > 0){
         ...
         $insert_wishlist = $conn->prepare("INSERT INTO `wishlist`(user_id, pid, name, price, image, dimensions) VALUES(?,?,?,?,?,?)");
...
if(isset($_POST['add_to_cart'])){
   ...
   if($user_id == ''){
      ...
      if($check_cart_numbers->rowCount() > 0){
         ...
         $insert_cart = $conn->prepare("INSERT INTO `cart`(user_id, pid, name, price, quantity, image, dimensions) VALUES(?,?,?,?,?,?,?)");
