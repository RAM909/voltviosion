...
<head>
   ...
   <style>
      ...
      #ordersChartContainer, #adminsUsersChartContainer, #productsChartContainer, #salesChartContainer {
         height: 300px; /* Adjust the height of the graph container */
      }
      canvas {
         max-height: 100%; /* Ensure the canvas fits within the container */
      }
      .main-content {
         flex-grow: 1;
         padding: 20px;
